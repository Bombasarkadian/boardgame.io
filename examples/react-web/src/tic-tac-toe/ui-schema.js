...
export const schema = {
  ...
  'card-O2': { type: ObjectType.CARD, opts: { text: 'O' } },
  'card-O3': { type: ObjectType.CARD, opts: { text: 'O' } },
  'card-O4': { type: ObjectType.CARD, opts: { text: 'O' } },
  'card-O5': { type: ObjectType.CARD, opts: { text: 'O' } },
  'card-O6': { type: ObjectType.CARD, opts: { text: 'O' } },
  'card-O7': { type: ObjectType.CARD, opts: { text: 'O' } },
  'card-O8': { type: ObjectType.CARD, opts: { text: 'O' } },
  'card-O9': { type: ObjectType.CARD, opts: { text: 'O' } },

  'card-X1': { type: ObjectType.CARD, opts: { text: 'X' } },
  'card-X2': { type: ObjectType.CARD, opts: { text: 'X' } },
  'card-X3': { type: ObjectType.CARD, opts: { text: 'X' } },
  'card-X4': { type: ObjectType.CARD, opts: { text: 'X' } },
  'card-X5': { type: ObjectType.CARD, opts: { text: 'X' } },
  'card-X6': { type: ObjectType.CARD, opts: { text: 'X' } },
  'card-X7': { type: ObjectType.CARD, opts: { text: 'X' } },
  'card-X8': { type: ObjectType.CARD, opts: { text: 'X' } },
  'card-X9': { type: ObjectType.CARD, opts: { text: 'X' } },
